				...
				<section class="row">
					<div class="col-lg-3 col-md-4 col-sm-12 header__logo">
						<h1 class="header__heading">
							<a href="/DoAnWWW_DongHo/index" class="header__logo-link"> <img
					...
					<div class="row">
							...
							<div id="carouselExampleIndicators" class="carousel slide"
								...
								<div class="carousel-inner">
									<div class="carousel-item active">
										<img style="width: 100%; margin-bottom: 1.6rem;"
											src="${theSP.imageURL}" class="product__main-img-primary"
											alt="...">
									</div>
									<div class="carousel-item">
										<img style="margin-bottom: 1.6rem; width: 100%;"
											src="${theSP.imageURL}" class="product__main-img-primary"
											alt="...">
									</div>
								</div>
						...
						<div class="product__main-info col-lg-8 col-md-8 col-sm-12">
							...
							<a href="#" class="product__main-info-title">
								<h2 class="product__main-info-heading">${theSP.tenSP}</h2>
							</a>

							<div class="product__main-info-rate-wrap">
								<i class="fas fa-star product__main-info-rate"></i> <i
									class="fas fa-star product__main-info-rate"></i> <i
									class="fas fa-star product__main-info-rate"></i> <i
									class="fas fa-star product__main-info-rate"></i> <i
									class="fas fa-star product__main-info-rate"></i>
							</div>

							<div class="product__main-info-price">
								<span class="product__panel-price-old "> <fmt:formatNumber
										value="${theSP.gia}" pattern="#,##0" /> đ
								</span> <span class="product__panel-price-current"> <fmt:formatNumber
										value="${theSP.gia - (theSP.gia * theSP.discount)}"
										pattern="#,##0" /> đ
								</span>
							</div>
							...
							<div class="product__main-info-description">
								...
								<div class="product__main-info-cart">
									...
									<div class="product__main-info-cart-btn-wrap">
										<form id="addToCartForm" method="post"
											action="<c:url value='/addToCart/${theSP.maSP}/${maKH}'/>">
								...
								<div class="product__main-info-contact">
									<a href="#" class="product__main-info-contact-fb"> <i
										class="fab fa-facebook-f"></i> Chat Facebook
									</a>
						...
						<div class="row bg-white">
							<div class="col-12 product__main-tab">
								<a href="#"
									...
									Mô tả </a> <a href="#" class="product__main-tab-link"> Đánh giá
								</a>
							</div>

							<div class="col-12 product__main-content-wrap">
								<p>
									<span>Lưu ý mua hàng:</span> <br> 1. Chúng tôi là công ty
									có thương hiệu thông thường và chúng tôi đảm bảo 100% cho sản
									phẩm mua của công ty mình. Chúng tôi sẽ cung cấp cho bạn dịch
									vụ sau bán hàng hoàn hảo. Nếu có vấn đề với sản phẩm bạn nhận
									được, vui lòng liên hệ với chúng tôi trong thời gian sớm nhất.
									Xin vui lòng không đánh giá trực tiếp, hãy cho phép chúng tôi
									giải quyết cho bạn và cho chúng tôi một cơ hội để phục vụ bạn,
									chúng tôi sẽ xử lý hoàn hảo cho bạn. <br> 2. Sản phẩm của
									chúng tôi đều có sẵn trong kho, do đó tốc độ giao hàng của
									chúng tôi rất nhanh, nếu có trường hợp đặc biệt, chúng tôi sẽ
									giải quyết vấn đề sớm nhất có thể, vì vậy hãy yên tâm mua hàng,
									chúng tôi là một công ty rất có trách nhiệm. <br> 3. Nếu
									có các thắc mắc khác, vui lòng liên hệ với dịch vụ chăm sóc
									khách hàng trực tuyến của chúng tôi, nhân viên chăm sóc khách
									hàng trực tuyến sẽ phục vụ bạn một cách hoàn hảo. <br> <span>
										Xem các biện pháp chống thấm nước:</span> <br> 1. Có thể đeo
									đồng hồ để bơi ở độ sâu 30 mét.<br> 2. Không vận hành các
									nút khi đồng hồ bị ướt.<br> 3. Không chạm vào chất lỏng ăn
									mòn<br> 4. Không chạm vào nước nóng, Vòng cao su chống
									thấm nước có thể giãn nở và co lại do nhiệt, ảnh hưởng đến tuổi
									thọ của đồng hồ.
								</p>
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<form id="formgroupcomment" method="post">
						<div class="form-group">
							<label>Tên:</label> <input name="comm_name" required=""
								type="text" id='form-name' class="form-control">
						</div>
						<div class="form-group">
							<label>Email:</label> <input name="comm_mail" required=""
								type="email" class="form-control" id="pwd">
						</div>
						<div class="form-group">
							<label>Nội dung:</label>
							<textarea name="comm_details" required="" rows="8"
								id='formcontent' class="form-control"></textarea>
						</div>
						<button type="submit" name="sbm" id="submitcomment"
			...
			<div class="product-comment row pb-4 pb-4  py-4 pb-4 py-4 py-4">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="comment-item">
						...
						<ul class=item-reviewer>
							<div class="comment-item-user">
								<img src="<c:url value="/resources/images/img/2.png" />" alt=""
							...
							<li>
								<h4>Đồng hồ quá hoàn hảo luôn, không 1 điểm chê, giao hàng
									nhanh trong ngày, shop tư vấn nhiệt tình. Hàng siêu chất lượng,
									đẹp !!</h4>
							</li>
						</ul>
					</div>
					...
					<div class="comment-item">
						<ul class=item-reviewer>
							<div class="comment-item-user">
								<img src="<c:url value="/resources/images/img/6.png" />" alt=""
									class="comment-item-user-img">
								<li><b>Văn Minh</b></li>
							</div>
							<br>
							...
							<li>
								<h4>Hàng chất lượng, mẫu mã đẹp. Tôi thấy sản phẩm rất đáng
									tiền, cảm thấy rất hài lòng. Mọi người nên mua đồng hồ ở
									WatchStore.</h4>
							</li>
						</ul>
					</div>
					...
					<div class="container">
						<div class="row">
							...
							<article class="footer__top-policy col-lg-3 col-md-4 col-sm-6">
								<h4 class="footer__top-policy-heading">Chính sách mua hàng
								</h4>
